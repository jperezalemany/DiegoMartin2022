...
def allPositionsInOneFile(ofile='result.xls',controlPositionFile=None,treatPositionFile=None,gainPositionFile=None,lossPositionFile=None,\
    ...
    if fdr==1:
        ...
        if numpy.any(occFDRlist==None):occFDRlist=occFDR(dwig=dwig,simu=fdrsimu,regions=fdrRegions)
        ...
        if numpy.any(fuzFDRlist==None):fuzFDRlist=fuzFDR(cwig=cwig,twig=twig,simu=fdrsimu,rd=rd,regions=fdrRegions)
